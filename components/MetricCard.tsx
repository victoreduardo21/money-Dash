...
const MetricCard: React.FC<MetricCardProps> = ({ title, value, icon, change, changeType, valueClassName }) => {
  ...
  return (
    <div className="p-4 md:p-5 bg-white dark:bg-gray-800 rounded-[1.25rem] md:rounded-[1.5rem] shadow-sm border border-slate-100 dark:border-gray-700 flex items-center space-x-3 md:space-x-4 transition-all duration-300 hover:shadow-md">
