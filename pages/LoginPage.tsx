...
const LoginPage: React.FC<LoginPageProps> = ({ onLogin }) => {
  ...
  const testUser: User = { name: 'Usuário Teste', email: 'teste@email.com', password: '123456' };
    ...
    <div className="flex items-center justify-center min-h-screen bg-gray-50 dark:bg-gray-900">
      <div className="w-full max-w-md p-8 space-y-6 bg-white dark:bg-slate-800 rounded-2xl shadow-xl">
        ...
        <div className="relative flex items-center">
            ...
            <span className="flex-shrink mx-4 text-gray-400 dark:text-gray-500 text-xs font-semibold">OU</span>
            <div className="flex-grow border-t border-gray-300 dark:border-gray-600"></div>
        </div>

        <button type="button" onClick={handleTestUserLogin} disabled={isLoading}
          className="group relative w-full flex justify-center py-3 px-4 border border-blue-500 text-sm font-medium rounded-md text-blue-600 bg-white hover:bg-blue-50 dark:bg-slate-800 dark:text-blue-400 dark:border-blue-400 dark:hover:bg-slate-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 dark:focus:ring-offset-slate-800 disabled:opacity-50 disabled:cursor-not-allowed transition-colors">
